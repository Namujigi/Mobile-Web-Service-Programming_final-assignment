...
def run(
    ...
    cd = ChangeDetection(names, required_frames_=5, patience_frames_=2) # 추가된 코드
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            detected = [0 for i in range(len(names))] # 추가된 코드
            ...
            cd.add(names, detected, save_dir, im0) # 추가된 코드
